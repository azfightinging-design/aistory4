...
async function generateImageByPrompt(prompt) {
    const res = await fetch(`${getApiBase()}/api/images`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
